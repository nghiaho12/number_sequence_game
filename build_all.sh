...
docker run --rm -it -v /tmp:/tmp --network=host number_sequence_game:android /bin/bash -c 'cp /SDL/build/org.libsdl.number_sequence_game/app/build/outputs/apk/debug/*.apk /tmp'
