...
docker run --rm -it -v /tmp:/tmp --network=host number_sequence:android /bin/bash -c 'cp /SDL/build/org.libsdl.number_sequence/app/build/outputs/apk/release/*.apk /tmp'
